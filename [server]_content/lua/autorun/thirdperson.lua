...
File Path:   addons/[server]_content/lua/autorun/thirdperson.lua
...
// SHARED
CreateConVar("simple_thirdperson_maxdistance", "80", { FCVAR_REPLICATED } , "Sets the max distance the player can go (0 = disabled)")
CreateConVar("simple_thirdperson_maxpitch", "45", { FCVAR_REPLICATED } , "Sets the max pitch the player can go (0 = disabled)")
CreateConVar("simple_thirdperson_maxright", "40", { FCVAR_REPLICATED } , "Sets the max right the player can go (0 = disabled)")
CreateConVar("simple_thirdperson_maxyaw", "10", { FCVAR_REPLICATED } , "Sets the max yaw the player can go (0 = disabled)")
CreateConVar("simple_thirdperson_maxup", "40", { FCVAR_REPLICATED } , "Sets the min up the player can go (0 = disabled)")

CreateConVar("simple_thirdperson_mindistance", "-20", { FCVAR_REPLICATED } , "Sets the min distance the player can go (0 = disabled)")
CreateConVar("simple_thirdperson_minpitch", "0", { FCVAR_REPLICATED } , "Sets the min pitch the player can go (0 = disabled)")
CreateConVar("simple_thirdperson_minright", "-40", { FCVAR_REPLICATED } , "Sets the min right the player can go (0 = disabled)")
CreateConVar("simple_thirdperson_minyaw", "-10", { FCVAR_REPLICATED } , "Sets the min yaw the player can go (0 = disabled)")
CreateConVar("simple_thirdperson_minup", "-40", { FCVAR_REPLICATED } , "Sets the min up the player can go (0 = disabled)")

CreateConVar("simple_thirdperson_shoulder_maxdist", "80", { FCVAR_REPLICATED } , "Sets the max shoulder distance the player can go (0 = disabled)")
...
CreateConVar("simple_thirdperson_shoulder_maxup", "40", { FCVAR_REPLICATED } , "Sets the max shoulder up the player can go (0 = disabled)")
CreateConVar("simple_thirdperson_shoulder_minup", "-40", { FCVAR_REPLICATED } , "Sets the min shoulder up the player can go (0 = disabled)")
CreateConVar("simple_thirdperson_shoulder_maxright", "40", { FCVAR_REPLICATED } , "Sets the max shoulder right the player can go (0 = disabled)")
CreateConVar("simple_thirdperson_shoulder_minright", "-40", { FCVAR_REPLICATED } , "Sets the min shoulder right the player can go (0 = disabled)")
...
if CLIENT then
	...
	CreateClientConVar( "simple_thirdperson_cam_distance", "80", true, false )
